public static boolean test0() throws Throwable {		
    ...
    org.apache.http.client.methods.HttpPost post_with_body = utopia.synthesized.util.Util.setEntity(post, "This is my body!");

    java.lang.String body = getEntity(post_with_body);
